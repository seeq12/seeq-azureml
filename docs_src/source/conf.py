...
# TODO: Need to refactor write_readme_sections_to_files this to make sure images are not copied with the same format
...
version = azureml.__version__
release = azureml.__version__
